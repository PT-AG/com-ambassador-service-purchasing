...
using Com.Ambassador.Service.Purchasing.Test.DataUtils.InternalPurchaseOrderDataUtils;
using Com.Ambassador.Service.Purchasing.Test.DataUtils.UnitReceiptNote;
...
using Com.Ambassador.Service.Purchasing.Test.DataUtils.DeliveryOrderDataUtils;
using Com.Ambassador.Service.Purchasing.Lib.Facades.BankExpenditureNoteFacades;
using Com.Ambassador.Service.Purchasing.Test.DataUtils.BankExpenditureNoteDataUtils;
using Com.Ambassador.Service.Purchasing.Lib.Facades.UnitReceiptNoteFacade;
using Com.Ambassador.Service.Purchasing.Test.DataUtils.UnitReceiptNoteDataUtils;
using Com.Ambassador.Service.Purchasing.Lib.ViewModels.Expedition;
...
using Com.Ambassador.Service.Purchasing.Test.DataUtils.UnitPaymentCorrectionNoteDataUtils;
using Com.Ambassador.Service.Purchasing.Test.DataUtils.UnitPaymentOrderDataUtils;
using Com.Ambassador.Service.Purchasing.Lib.Facades.GarmentInvoiceFacades;
using Com.Ambassador.Service.Purchasing.Test.DataUtils.GarmentInvoiceDataUtils;
using Com.Ambassador.Service.Purchasing.Test.DataUtils.GarmentInternNoteDataUtils;
...
namespace Com.Ambassador.Service.Purchasing.Test
{
        ...
        public ServiceProviderFixture()
        {
            IConfigurationRoot configuration = new ConfigurationBuilder()
                .AddInMemoryCollection(new List<KeyValuePair<string, string>>
                {
                    ...
                    new KeyValuePair<string, string>(Constant.DEFAULT_CONNECTION, "Server=localhost,1401;Database=com.Ambassador.db.purchasing.service.test;User Id=sa;Password=Standar123.;MultipleActiveResultSets=True;"),
