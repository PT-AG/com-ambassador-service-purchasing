...
namespace Com.Ambassador.Service.Purchasing.Lib.ViewModels.GarmentSubcon.GarmentSubconDeliveryOrderViewModel
{
    public class MonitoringSubconDeliveryOrderVM
    {
