...
namespace Com.Ambassador.Service.Purchasing.Lib.ViewModels.GarmentSubcon.GarmentUnitDeliveryOrderViewModel
{
                    ...
                    foreach (var item in Items)
                    {
                        ...
                        if (item.IsSave)
                        {
                            ...
                            else
                            {
                                ...
                                var UrnItem = dbContext.GarmentSubconUnitReceiptNoteItems.AsNoTracking().FirstOrDefault(x => x.Id == item.URNItemId);
                                if (UrnItem != null)
                                {
