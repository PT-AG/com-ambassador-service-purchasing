...
namespace Com.Ambassador.Service.Purchasing.Lib.Facades.GarmentInternalPurchaseOrderFacades
{
    public class GarmentInternalPurchaseOrderFacade : IGarmentInternalPurchaseOrderFacade
    {
        ...
        {
            IQueryable<GarmentInternalPurchaseOrder> Query = this.dbSet.Include(x => x.Items).Where(x => !x.CreatedBy.Equals("Manager123"));
        ...
        {
            IQueryable<GarmentInternalPurchaseOrder> Models = this.dbSet.AsQueryable().Where(x => !x.CreatedBy.Equals("Manager123"));
