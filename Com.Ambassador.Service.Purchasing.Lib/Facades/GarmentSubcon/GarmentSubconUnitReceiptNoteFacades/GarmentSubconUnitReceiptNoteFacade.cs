...
using Com.Ambassador.Service.Purchasing.Lib.ViewModels.GarmentSubcon.GarmentUnitReceiptNoteViewModels;
...
namespace Com.Ambassador.Service.Purchasing.Lib.Facades.GarmentSubcon.GarmentSubconUnitReceiptNoteFacades
{
    public class GarmentSubconUnitReceiptNoteFacade : IGarmentSubconUnitReceiptNoteFacade
    {
        ...
        public ReadResponse<object> Read(int Page = 1, int Size = 25, string Order = "{}", string Keyword = null, string Filter = "{}")
        {
            ...
            ListData.AddRange(Data.Select(s => new
            {
                ...
                s.ReceiptDate,
                Supplier = new { Name = s.ProductOwnerName,Id = s.ProductOwnerId,Code=s.ProductOwnerCode},
                s.DONo,
