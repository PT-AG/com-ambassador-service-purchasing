...
namespace Com.Ambassador.Service.Purchasing.Lib.AutoMapperProfiles.GarmentSubcon
{
    public class GarmentSubconUnitExpenditureNoteProfile : Profile
    {
        public GarmentSubconUnitExpenditureNoteProfile()
        {
            CreateMap<GarmentSubconUnitExpenditureNote, GarmentSubconUnitExpenditureNoteViewModel>()
            ...
            CreateMap<GarmentSubconUnitExpenditureNoteItem, GarmentSubconUnitExpenditureNoteItemViewModel>()
                ...
                .ForPath(d => d.BuyerId, opt => opt.MapFrom(s => s.ProductOwnerId))
                .ForPath(d => d.BuyerCode, opt => opt.MapFrom(s => s.ProductOwnerCode))
