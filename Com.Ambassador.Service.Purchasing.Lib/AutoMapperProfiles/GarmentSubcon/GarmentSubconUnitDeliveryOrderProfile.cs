...
{
    public class GarmentSubconUnitDeliveryOrderProfile : Profile
    {
        public GarmentSubconUnitDeliveryOrderProfile()
        {
            CreateMap<GarmentSubconUnitDeliveryOrder, GarmentSubconUnitDeliveryOrderViewModel>()
            ...
            CreateMap<GarmentSubconUnitDeliveryOrderItem, GarmentSubconUnitDeliveryOrderItemViewModel>()
